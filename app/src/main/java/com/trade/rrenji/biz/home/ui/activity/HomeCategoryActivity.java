...
public class HomeCategoryActivity extends BaseActivity implements HomeCategoryActivityView {
    ...
    private void init() {
        mPresenter.getModelAttr(this, mCategoryId);
...
//        mSuperRecyclerView.addItemDecoration(new LinearSpacingDecoration(5, 5));
    ...
    public void getModelAttrSuccess(NetScreenBean netShareBean) {
        ...
        if (mPopupAdapter != null) {
            ...
            mPopupAdapter = new PopupAdapter(HomeCategoryActivity.this);
    ...
    private void lodDataScreen() {
        mPresenter.getAttributeProductList(this, mPriceSort, mPageIndex, mCategoryId, mDefaultMemory, mDefaultColor, mDefaultNetwork, mDefaultCondition, mDefaultVersion);
    }
