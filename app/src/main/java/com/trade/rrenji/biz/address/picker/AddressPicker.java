package com.trade.rrenji.biz.address.picker;
...
public class AddressPicker extends WheelPicker {
    ...
    public void init(ArrayList<Province> data) {
    ...
    protected View initContentView() {
        ...
        ArrayList<ArrayList<String>> county = countyList.get(selectedProvinceIndex);
        ArrayList<String> c = county.get(selectedCityIndex);
        countyView.setItems(c, selectedCountyIndex);
