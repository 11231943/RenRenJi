...
public class SearchValueAdapter extends RecyclerListAdapter<NetSearchValueBean.ResultBean.GoodsListBean> {

    Context mContext;
    List<ResultListBean> mCategoryList;

    public SearchValueAdapter(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public class CategoryListViewHolder extends ViewHolder {
        ...
        @Override
        public void bindData(final NetSearchValueBean.ResultBean.GoodsListBean data, int position) {
