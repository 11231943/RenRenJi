package com.trade.rrenji.biz.sale.ui.adapter;
 ...
 */
public class SaleAdapter extends RecyclerListAdapter<AddressListBean> {
    ...
    public void setOnClickListener(SaleAdapter.onClickListener onClickListener) {
    ...
    public SaleAdapter(Activity context) {
        super(context);
        mContext = context;
    }
