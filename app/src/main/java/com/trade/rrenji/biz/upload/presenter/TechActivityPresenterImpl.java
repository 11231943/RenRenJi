...
public class TechActivityPresenterImpl extends BasePresenter<TechActivityView> implements TechActivityPresenter {

    private TechModel mModel;

    Context mContext;

    public TechActivityPresenterImpl(Context context) {
        mContext = context;
