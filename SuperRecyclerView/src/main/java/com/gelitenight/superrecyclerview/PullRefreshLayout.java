...
public class PullRefreshLayout extends ViewGroup {
    ...
    private boolean disablePullRefresh;
...
//        mRefreshDrawable.setColorSchemeColors(new int[]{Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B, 0xF1), Color.rgb(0xF7, 0xD2, 0x3E), Color.rgb(0x34, 0xA3, 0x50)});
    ...
    public void setRefreshStyle() {
        ...
        mRefreshDrawable = new ProgressCircleDrawable(getContext(), this);
...
//                    float adjustedPercent = dragPercent;
    ...
    public void startRefresh(boolean showRefreshHeader) {
        setRefreshing(showRefreshHeader);
        if (mListener != null) {
            mListener.onRefresh();
        }
    }
